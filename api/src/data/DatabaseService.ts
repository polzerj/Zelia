...
import { getRoomReservations, setRoomReservation, RoomReservation } from "./RoomReservationConnection";
...
export async function getRoomReservationByRoomNumber(roomNumber: string): Promise<RoomReservationEntity[]> {
...
export async function getAdminUserByNameAndPw(userName: string, hash: string): Promise<AdminUserEntity> {
    let data: AdminUser;
    try {
