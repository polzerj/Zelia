...
\hfive{Klassenobjekt}
\yaml{code/ZeliaAPI/Klassenobjekt.yaml}{Definiton eines Klassenobjekts}
...
\hfive{Lehrerobjekt}
\yaml{code/ZeliaAPI/Lehrerobjekt.yaml}{Definiton eines Lehrerobjekts}
...
\yaml{code/ZeliaAPI/Gegenstandsobjekt.yaml}{Definition eines Gegenstandsobjekts}
