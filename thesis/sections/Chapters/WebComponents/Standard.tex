...
Custom Elements sind ES6 Klassen, welche von der Klasse "HTMLElement" erben. "ES6" steht für "ECMA Script 6" und ist der Standard, welcher Klassen in Javascript hinzugefügt hat.\cite{MDNes6Classes}
...
Der "attributeChangedCallback" Lifecycle-Hook wird jedes Mal aufgerufen, wenn ein Attribut des Custom Elements geändert wird. Allerdings müssen dafür eine Liste an Attributnamen von der statischen Eigenschaft "observedAttributes" zurückgegeben werden. 
...
Ein Shadow DOM ist ein DOM Subtree, welcher separat von der restlichen Seite gerendert wird. Dadurch kann auch auf Custom Elements ein Style in Style-Tags erstellt werden, ohne das Design der restlichen Seite zu beeinflussen. \cite{MDNShadowRoot}
...
Um das Custom Element mit Inhalten zu füllen, gibt es in HTML den "template"-Tag, welcher nicht im DOM gerendert wird, aber trotzdem mit Javascript referenziert werden kann. \cite{MDNtemplate}

\html{code/WebComponents/nine.html}{Erstellung eines HTML Templates}

Damit das Template in ein Custom Element zu gerendert wird, muss der Content in das Custom Element, oder dessen Shadow DOM kopiert werden.
