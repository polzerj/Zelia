...
Die Fehlerseite ist keine eigene Seite wie die anderen Seiten. Sie besteht nur aus der 404-"Not Found" Komponente und wird angezeigt wenn auf einen nicht vorhandenen Pfad zugegriffen wird. Somit hat diese Seite keinen eigen Pfad und kann nicht wirklich als Seite von ZELIA gezählt werden.
