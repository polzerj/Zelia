...
{\ttfamily openssl x509 -in beispiel.csr -out beispiel.crt -req \newline -signkey beispiel.key -days 3650}

Dieser Befehl erstellt ein Zertifikat im "x509"-Standard. Mit dem "{\ttfamily -days}" Parameter kann man die Gültigkeitsdauer des Zertifikats angeben. \cite{ZertifikateTLS}
