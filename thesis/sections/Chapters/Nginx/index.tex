...
Innerhalb der Locations wird definiert, wie NGINX die Anfragen behandeln soll. In diesem Beispiel werden alle Anfragen innerhalb des "/api"-Pfads an den auf \linebreak {\ttfamily http://api:3001} laufenden Server weitergeleitet.
