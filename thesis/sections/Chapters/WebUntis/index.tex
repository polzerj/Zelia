...
\begin{figure}[h]
    \centering
    \includegraphics{media/WebUntis/getIDbyRoomNumber.png}
    \caption{Raum über ID zurückbekommen}
\end{figure}
...
Des Weiteren gab es das Problem, das WebUntis einen Token eingebaut hat, welcher nach einer gewissen Zeit abläuft und die momentane Sitzung als "ungültig" deklariert.
...
\begin{figure}[h]
    \centering
    \includegraphics{media/WebUntis/ExceptionHandling.png}
