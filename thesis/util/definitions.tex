...
\newcommand{\plaintext}[3][1]{\begin{minipage}{\linewidth} \begin{singlespacing}\lstinputlisting[language=TypeScript,caption={#3},label={#1},captionpos=b]{#2}\end{singlespacing} \end{minipage}}
%------------------------------------------------------------------------------
